...
"""
FastAPI application for the Manga Tracker Environment.

This module creates an HTTP server that exposes the MangaTrackerEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m manga_tracker.server.app
    ...
    multiple workers:
        uvicorn manga_tracker.server.app:app --workers 4
    """
    import uvicorn
